...
// $Id: stopwatch.hpp,v 1.1.1.1 2006/11/29 15:58:24 seanc Exp $
//------------------------------------------------------------------------------
...
public:
  ...
  inline double GetTime() const;     // Instantaneous elapsed time
  double GetAvgTime() const;  // NOT ACCURATE IF NOT STOPPED!
...
protected:
  double elapsedTime;     // the accumulated elapsed time
  ...
  virtual double diffTime() const =0; // return  current_timestamp - last_mark
};
 ...
 * Reset().
 */
inline double StopwatchBase::GetTime() const
{
